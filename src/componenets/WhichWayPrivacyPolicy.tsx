...
const externalLink = "text-accent underline underline-offset-4";

// Served at both /gameprivacy (the URL on the existing Play listing) and /games/whichway/privacy.
const WhichWayPrivacyPolicy = () => {
  return (
    <GamePrivacyLayout game="WHICHWAY" lastUpdated="September 16, 2026">
      <p>
        WhichWay is developed by {pageInfo.name} (BatihanDev). This policy
      ...
      <PolicySection title="Advertising">
        <p>
          ...
          <a className={externalLink} href="https://policies.google.com/technologies/partner-sites">
      ...
      <PolicySection title="Service providers">
        <p>
          ...
          <a className={externalLink} href="https://policies.google.com/privacy">
            Google Privacy Policy
          </a>{" "}
          and{" "}
          <a className={externalLink} href="https://unity.com/legal/privacy-policy">
...
export default WhichWayPrivacyPolicy;
